...
def build_turn_metadata(debug: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "response_generation_enabled": debug.get("response_generation_enabled"),
        "response_model_name": debug.get("response_model_name"),
        "response_generation_attempted": debug.get("response_generation_attempted"),
        "response_generation_used_llm": debug.get("response_generation_used_llm"),
        "response_generation_mode": debug.get("response_generation_mode"),
        "response_generation_rejected_reason": debug.get("response_generation_rejected_reason"),
        "final_response_mode": debug.get("final_response_mode"),
